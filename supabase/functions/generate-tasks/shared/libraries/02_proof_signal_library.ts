export const proofSignalLibrary = {
  "proof_signal_library": [
    ...
    {
      "id": "ps_negotiation_1",
      "description": "Negotiated contracts or deals with vendors, partners, or clients",
      "tags": [
        "negotiation",
        "contracts",
        "vendors",
    ...
    {
      "id": "ps_negotiation_2",
      "description": "Led pricing or commercial terms discussions resulting in a closed deal",
      "tags": [
        "negotiation",
        "pricing",
        "deals",
    ...
    {
      "id": "ps_negotiation_3",
      "description": "Resolved disputes or conflicting interests between parties through structured negotiation",
      "tags": [
        "negotiation",
        "conflict resolution",
        "stakeholders"
    ...
    {
      "id": "ps_salesforce_1",
      "description": "Managed leads, accounts, and opportunities in Salesforce CRM",
      "tags": [
        "salesforce",
        "crm",
        "pipeline"
    ...
    {
      "id": "ps_salesforce_2",
      "description": "Built Salesforce reports, dashboards, and custom views for revenue teams",
      "tags": [
        "salesforce",
        "reports",
        "dashboards"
    ...
    {
      "id": "ps_salesforce_3",
      "description": "Administered Salesforce configuration, workflows, or custom objects",
      "tags": [
        "salesforce admin",
        "configuration",
        "workflows"
    ...
    {
      "id": "ps_empathy_1",
      "description": "Provided empathetic support to customers during escalations or high-stress issues",
      "tags": [
        "empathy",
        "support",
        "customer care",
    ...
    {
      "id": "ps_empathy_2",
      "description": "Adapted communication style to diverse audiences and emotional contexts",
      "tags": [
        "empathy",
        "communication",
        "adaptability"
    ...
    {
      "id": "ps_presentation_1",
      "description": "Delivered presentations to executives, clients, or large audiences",
      "tags": [
        "presentation",
        "public speaking",
        "executive"
    ...
    {
      "id": "ps_presentation_2",
      "description": "Created and presented pitch decks, project proposals, or business cases",
      "tags": [
        "pitch deck",
        "proposal",
        "presentation"
    ...
    {
      "id": "ps_presentation_3",
      "description": "Led training sessions, workshops, or educational sessions for teams",
      "tags": [
        "training",
        "workshops",
        "presenting"
    ...
    {
      "id": "ps_brand_1",
      "description": "Developed or maintained brand guidelines, messaging, or positioning",
      "tags": [
        "brand",
        "brand guidelines",
        "positioning"
    ...
    {
      "id": "ps_brand_2",
      "description": "Managed brand consistency across marketing channels and customer touchpoints",
      "tags": [
        "brand consistency",
        "marketing",
        "messaging"
    ...
    {
      "id": "ps_eq_1",
      "description": "Managed team conflicts and mediated between stakeholders with different agendas",
      "tags": [
        "conflict resolution",
        "mediation",
        "interpersonal"
    ...
    {
      "id": "ps_eq_2",
      "description": "Adapted leadership style based on team member needs and team dynamics",
      "tags": [
        "leadership",
    ...
    {
      "id": "ps_canva_1",
      "description": "Created marketing materials or social media graphics using Canva or similar design tools",
      "tags": [
        "canva",
        "design",
        "graphics",
    ...
    {
      "id": "ps_canva_2",
      "description": "Designed presentation decks and visual content with custom design work",
      "tags": [
        "design",
        "presentation design",
        "visual"
    ...
    {
      "id": "ps_discovery_1",
      "description": "Conducted customer interviews to validate product hypotheses or gather requirements",
      "tags": [
        "user research",
        "customer discovery",
        "interviews"
    ...
    {
      "id": "ps_discovery_2",
      "description": "Led discovery sessions to uncover customer pain points and needs",
      "tags": [
        "discovery",
        "research",
        "customer needs"
    ...
    {
      "id": "ps_objection_1",
      "description": "Addressed customer concerns and objections to close deals or retain accounts",
      "tags": [
        "objection handling",
        "sales",
        "closing"
    ...
    {
      "id": "ps_objection_2",
      "description": "Turned customer complaints or concerns into renewal or upsell opportunities",
      "tags": [
        "objection handling",
        "retention",
        "upsell"
    ...
    {
      "id": "ps_organization_1",
      "description": "Managed complex schedules and coordinated multi-team logistics under tight deadlines",
      "tags": [
        "organization",
        "scheduling",
        "coordination"
    ...
    {
      "id": "ps_organization_2",
      "description": "Coordinated simultaneous projects with competing priorities and deadlines",
      "tags": [
        "organization",
        "multi-tasking",
    ...
    {
      "id": "ps_commercial_1",
      "description": "Identified revenue opportunities and recommended commercial strategies to leadership",
      "tags": [
        "revenue",
        "commercial",
        "business"
    ...
    {
      "id": "ps_commercial_2",
      "description": "Contributed to pricing, packaging, or go-to-market decisions",
      "tags": [
        "pricing",
        "go-to-market",
        "commercial"
    ...
    {
      "id": "ps_partner_1",
      "description": "Managed relationships with external partners, vendors, or channel resellers",
      "tags": [
        "partner management",
        "vendors",
        "relationships"
    ...
    {
      "id": "ps_partner_2",
      "description": "Coordinated joint initiatives with partner organizations and tracked partnership ROI",
      "tags": [
        "partnerships",
        "joint initiatives",
        "partner ROI"

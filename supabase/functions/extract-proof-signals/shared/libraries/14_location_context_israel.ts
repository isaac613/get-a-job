export const locationContextIsrael = {
  "name": "location_context_israel",
  "version": "v1",
    ...
    "most_accessible": [
      {
        ...
        "why": "Strong communication and basic product understanding is often enough. High demand across the market. One of the clearest entry paths into high-tech for business graduates."
      },
      {
        "role": "SDR / BDR (Sales Development Representative)",
        "why": "High-volume hiring. Requires resilience and commercial drive more than specific technical knowledge. Good entry point with clear progression."
      },
      {
        "role": "Marketing Coordinator",
        "why": "Accessible for business graduates with content, social, or analytical skills. Common at both startups and scale-ups."
      },
      {
        "role": "Business Analyst",
        "why": "Good fit for analytically strong graduates. Often a bridge into product, operations, or strategy."
      },
      {
        "role": "Project Coordinator",
        "why": "Accessible for organized graduates with cross-functional experience. Common at implementation-heavy companies."
      }
    ],
    "competitive_roles": [
      {
        "role": "Junior Product Manager",
        "why": "Highly competitive. Most junior PM roles in Israel require either a strong technical background or prior experience in a related role such as CS, product ops, or analyst. Pure business graduates without technical signals rarely land PM roles directly out of university.",
        "realistic_path": "Build toward PM via Customer Success, Business Analysis, or Product Operations first"
      }
    ]
  },
  "company_landscape": {
    "israeli_tech_companies": [
      {
        "name": "Monday.com",
        "type": "Israeli scale-up",
        "known_for": "Work OS platform, strong employer brand, large sales and CS teams",
        "good_for": "Sales, Customer Success, Marketing, Business roles"
      },
      {
        "name": "Wix",
        "type": "Israeli scale-up",
        "known_for": "Website builder platform, large product and engineering teams",
        "good_for": "Product, Marketing, Customer Success"
      },
      {
        "name": "Fiverr",
        "type": "Israeli scale-up",
        "known_for": "Freelance marketplace, strong product and marketing culture",
        "good_for": "Product, Marketing, Operations"
      },
      {
        "name": "SimilarWeb",
        "type": "Israeli scale-up",
        "known_for": "Digital intelligence platform, strong sales and CS culture",
        "good_for": "Sales, Customer Success, Marketing"
      },
      {
        "name": "Check Point",
        "type": "Israeli enterprise",
        "known_for": "Cybersecurity, one of Israel's oldest and largest tech companies",
        "good_for": "Sales, Marketing, Operations, Technical roles"
      },
      {
        "name": "Mobileye",
        "type": "Israeli enterprise (Intel subsidiary)",
        "known_for": "Autonomous driving technology",
        "good_for": "Technical and engineering roles primarily"
      },
      {
        "name": "Rapyd",
        "type": "Israeli fintech scale-up",
        "known_for": "Fintech infrastructure, fast-growing",
        "good_for": "Sales, Operations, Product"
      },
      {
        "name": "Papaya Global",
        "type": "Israeli HR-tech scale-up",
        "known_for": "Global payroll platform",
        "good_for": "Sales, Customer Success, Operations"
      },
      {
        "name": "AppsFlyer",
        "type": "Israeli scale-up",
        "known_for": "Mobile attribution and marketing analytics",
        "good_for": "Sales, Customer Success, Marketing, Data"
      },
      {
        "name": "Lemonade",
        "type": "Israeli-American insurtech",
        "known_for": "AI-powered insurance",
        "good_for": "Operations, Customer Success, Data"
      }
    ],
    "multinational_offices_in_israel": [
      {
        "name": "Google Tel Aviv",
        "notes": "Prestigious, competitive, strong technical bar. Slower hiring process."
      },
      {
        "name": "Meta Tel Aviv",
        "notes": "Strong engineering and product presence. Competitive hiring."
      },
      {
        "name": "Amazon Tel Aviv",
        "notes": "Engineering and cloud focus. Structured hiring process."
      },
      {
        "name": "Microsoft Israel",
        "notes": "Large presence, R&D focus, more structured than startups."
      },
      {
        "name": "Salesforce Israel",
        "notes": "Strong sales and CS culture locally. Good for business graduates."
      }
    ],
    "startup_ecosystem": {
  ...
  "salary_context": {
    ...
    "notes": [
      "Entry-level roles in high-tech in Tel Aviv typically range from 8,000 to 14,000 NIS per month gross depending on role and company",

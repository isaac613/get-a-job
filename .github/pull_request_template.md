...
<!-- One paragraph. What does this change do, and why? Link the ROADMAP.md item if applicable. -->

## Test plan

<!-- How did you verify? List manual tests, edge cases checked, screenshots if UI. -->

- [ ] `npm test` passes
- [ ] `npm run build` passes
- [ ] Tested manually in browser (if UI change)
- [ ] Tested with a real Supabase user (if DB / RLS / edge function change)
...
<!-- Anything that needs context the diff doesn't show. "I considered X but went with Y because Z" is great. -->

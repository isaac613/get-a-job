...
const SUBAGENTS = [
  ...
  },
  {
    ...
    howToUse: "Pick an application at the top of the page, or ask a general CV question. When you say \"generate a CV for <role>\", the agent proposes a confirm card — click Generate CV to produce the PDF.",
  },
  {
    id: "interview_coach",
